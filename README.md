...
process, it adds the VMware vmxnet3 virtual network drivers for Windows 11 ARM (provided by the VMware Fusion application bundle). 
...
As an optional feature, the ISO generated by w11arm_addDrivers can be configured to remove the inconvenient Microsoft "feature" 
of "Press any key to boot from CD or DVD..." and boot directly into the Windows setup without any further intervention.
...
- Microsoft's public download site for Windows 11 for ARM PCs (https://www.microsoft.com/en-us/software-download/windows11arm64)
